...
export const Who = forwardRef(({ 
  ...
  return (
    <>
      ...
      />
      {/* MAX GUESTS */}
      <View ref={setFieldRef && setFieldRef('maxGuests')} style={styles.inputContainer}>
      ...
      {/* RSVP DEADLINE */}
      <View ref={setFieldRef && setFieldRef('rsvpDeadline')} style={styles.inputContainer}>
      ...
      {formData.rsvpDeadlineType === 'custom' && (
        <View style={styles.inputContainer}>
          <Text style={[styles.label, { marginTop: 15 }]}>Custom RSVP Deadline *</Text>
          <PickerRow
