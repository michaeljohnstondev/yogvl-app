  ...
  const [pickerData, setPickerData] = useState(() => {
    ...
    Object.keys(config).forEach((key) => {
      ...
      initialState[key] = {
        ...
        dateSelected: pickerConfig.initialDateSelected || false, // Use initial date selection state
    ...
    ({ pickerId, type, placeholder, icon, style }) => {
      ...
      return (
        <VibeButtonPlain
          ...
          style={[
            styles.pickerButton, // Add fixed sizing
            !isSelected && styles.unselectedButton,
            showCompletion && styles.completedButton,
            style,
          ]}
          textStyle={styles.pickerButtonText} // Add text styling for overflow
...
const styles = StyleSheet.create({
  ...
  pickerButton: {
    ...
    paddingVertical: 12, // Keep original vertical padding
  },
  pickerButtonText: {
    textAlign: 'center',
  },
