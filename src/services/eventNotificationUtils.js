...
export const updateEventNotifications = async (
  ...
  try {
    ...
    if (changes.includes('title')) {
      ...
      console.warn(
        '[EventNotificationUtils] Cross-user notification updates should use Cloud Functions'
      );
      ...
      return {
        success: false,
        error:
          'Cross-user notification updates not supported in user-scoped architecture. Use Cloud Functions.',
        action: 'deprecated',
      };
