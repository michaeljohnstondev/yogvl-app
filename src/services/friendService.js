...
export const acceptCohostInvitation = async (
  ...
  try {
    console.log('[acceptCohostInvitation] Starting with:', {
      invitationId,
      recipientId,
      eventId,
    });
    ...
    console.log(
      '[acceptCohostInvitation] Recipient data structure:',
    ...
    console.log(
      '[acceptCohostInvitation] Extracted accepter name:',
      accepterName
    );
...
export const leaveCohostRole = async (userId, eventId, studioId) => {
  try {
    ...
    console.log(
      `[leaveCohostRole] User ${userId} left cohost role for event ${eventId}`
    );
    return { success: true };
  } catch (error) {
...
export const removeCohostFromEvent = async (
  ...
  try {
    ...
    console.log(
      `[removeCohostFromEvent] Creator ${eventCreatorId} removed cohost ${cohostUserId} from event ${eventId}`
    );
    return { success: true };
  } catch (error) {
...
export const sendGuestInvitation = async (
  ...
  try {
    // Check if invitation already exists
    const existingInvitation = await getGuestInvitationStatus(
      recipientId,
      eventId
    );
    if (existingInvitation) {
...
export const removeFromFavorites = async (currentUserId, targetUserId) => {
  try {
    ...
    console.log(
      `Removed user ${targetUserId} from favorites for ${currentUserId}`
    );
    return { success: true };
  } catch (error) {
...
export const removeFriend = async (currentUserId, targetUserId) => {
  try {
    ...
    console.log(
      `Removed friendship between ${currentUserId} and ${targetUserId}`
    );
    return { success: true };
  } catch (error) {
...
export const clearFriendshipData = async (userId1, userId2) => {
  try {
    ...
    console.log(
      `Cleared all friendship data between ${userId1} and ${userId2}`
    );
    return { success: true };
  } catch (error) {
